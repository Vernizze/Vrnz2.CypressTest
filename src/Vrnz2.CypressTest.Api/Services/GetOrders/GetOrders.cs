...
namespace Vrnz2.CypressTest.Api.Services.GetOrders
{
    public class GetOrders
    {
            ...
            : IRequestHandler<Model.Input, Model.Output>
        {
            ...
            public async Task<Model.Output> Handle(Model.Input request, CancellationToken cancellationToken)
                => await Task.FromResult(new Model.Output { Success = true, StatusCode = (int)HttpStatusCode.OK, Content = OrdersRepository.Instance.GetOrders() });
